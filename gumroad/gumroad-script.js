...
var _get = function get(e, t, i) {
  ...
  , GumroadClass = function() {
    ...
    return _createClass(e, [{
        ...
        value: function i() {
            MutationObserver && (this.nodeAdditionObserver = new MutationObserver(function(e) {
                for (var t = 0; t < e.length; t++)
                    for (var i = 0; i < e[t].addedNodes.length; i++)
                        this.nodeAdditionCallback && this.nodeAdditionCallback(e[t].addedNodes[i])
            }
            .bind(this)),
            this.nodeAdditionObserver.observe(document.body, {
                childList: !0,
                subtree: !0
            }))
        }
        ...
        value: function o(e) {
            ...
            return r.searchParams.append("affiliate_id", i.affiliateId),
            r.href
        }
    }, {
...
var GumroadLink = function() {
    function a(e, t) {
        ...
        i && this.element.setAttribute("href", this.convertAffiliateProductUrl(i)),
        this.validateUrl(),
        this.vars.affiliate_id && (this.vars.url_parameters.affiliate_id = this.vars.affiliate_id)
    }
    return _inherits(a, GumroadClass),
    _createClass(a, [{
        key: "makeActiveLink",
        value: function o() {
            var e = document.createElement("span")
              , t = this
              , i = !1;
            if (e.className = this.manager.logoClassName,
            !this.element.getAttribute("data-gumroad-ignore")) {
        ...
        value: function r() {
            for (var e = this.element.href.split("?"), t = e[0], i = 0; i < this.manager.productMatches.length; i++) {
                ...
                if (0 === t.indexOf(a)) {
                    ...
                    return this.vars.permalink = n[0],
  ...
  , GumroadOverlayManager = function() {
    function e() {
        ...
        .bind(this), !1) : window.attachEvent("onmessage", function(e) {
            this.gotMessage(e)
        }
        .bind(this), !1),
        this.setDomain(),
    ...
    return _inherits(e, GumroadClass),
    _createClass(e, [{
        key: "setDomain",
        value: function t() {
        ...
        value: function a(e, t) {
            ...
            this.hasClass(e, t) && (i.push(t),
            e.className = className.join(" "))
        }
    }, {
        key: "addLinks",
        value: function n() {
            for (var e = document.querySelectorAll("a:not(.gr-overlay-disabled),area"), t = this, i = 0; i < e.length; i++)
                new GumroadLink(e[i],t)
        }
    }, {
        key: "append",
        value: function i(e, t) {
            t = t || "body",
            document.getElementsByTagName(t)[0].appendChild(e)
        }
    }, {
        key: "askForProduct",
        value: function r() {
            if (this.currentLink) {
                ...
                e && (this.currentLink.vars.googleAnalyticsClientId = e),
                this.messageIframe({
        ...
        value: function o() {
            if ("string" == typeof window.GoogleAnalyticsObject && "function" == typeof window[window.GoogleAnalyticsObject] && "function" == typeof window[window.GoogleAnalyticsObject].getAll) {
                ...
                if ("object" == typeof t && "function" == typeof t.get)
        ...
        value: function l() {
            var e = (this.domain ? this.domain : "") + "/overlay_page"
              , t = [];
            if (this.isSingleProductMode && t.push("single_product_mode=true"),
            this.allPermalinks && 0 < this.allPermalinks.length && t.push("all_permalinks=" + this.allPermalinks.join(",")),
            this.currentLink)
                for (var i in this.currentLink.vars)
                    this.currentLink.vars.hasOwnProperty(i) && t.push(i + "=" + this.currentLink.vars[i]);
            return 0 < t.length && (e += "?" + t.join("&")),
            e
        }
    }, {
        ...
        key: "handshake",
        value: function u() {
            this.iframeReady || (this.iframeReady = !0,
            clearInterval(this.handshakeTimer),
            delete this.handshakeTimer,
            this.messagingSetupCallback())
        }
    }, {
        key: "hasClass",
        ...
        value: function v() {
            ...
            this.setScrollContainerStyle(t),
            this.resizeIframe(t)
        }
    }, {
        key: "messageIframe",
        value: function y(e) {
            this.iframe && ("object" == typeof e && (e = JSON.stringify(e)),
            this.iframe.contentWindow.postMessage(e, this.domain))
        }
    }, {
        ...
        value: function k(e) {
            this.hideLoadingIndicator(),
            this.isSingleProductMode ? this.setScrollContainerStyle() : (this.setScrollContainerStyle(e),
            this.resizeIframe(e)),
            this.messageIframe("stopPreviews")
        }
    }, {
        ...
        value: function _(e) {
            if (this.iframe) {
                ...
                (e = e || {
                    width: "0px",
                    height: "0px"
                }).width && t.push("width: " + e.width),
                e.height && t.push("height: " + e.height),
                this.iframe.style = t.join(";")
            }
        }
    }, {
        key: "sendDomain",
        ...
        key: "setEnvironment",
        value: function P() {
            _get(Object.getPrototypeOf(e.prototype), "setEnvironment", this).call(this),
            this.productMatches = ["http://gum.co/", "https://gum.co/", "https://gumroad.com/l/"]
        }
    }, {
        key: "setOpacity",
        value: function L(e, t) {
            e.style.display = 0 === t ? "none" : "block",
            e.style.opacity = e.style.MozOpacity = e.style.khtmlOpacity = t,
        ...
        value: function N(e) {
            ...
            this.iframeReady ? this.askForProduct() : this.createIframe()
        }
    }, {
